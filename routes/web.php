...
Route::prefix('painel')->group(function() {
    ...
    Route::put('category', [CategoryController::class, 'update'])->name('categoryUpdate')->middleware('auth');
    ...
    Route::prefix('outgoing')->group(function () {
        ...
        Route::POST('indexPost', [OutGoingController::class, 'index'])->name('indexPost')->middleware('auth');
        ...
        // Route::get('searchOutgoing', [OutGoingController::class, 'index'])->name('outgoingsSearch')->middleware('auth');
